		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#Perdomocinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Perdomocinvoices-display": {
								"semanticObject": "Perdomocinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Perdomoc.invoices",
									"url": sap.ui.require.toUrl("Perdomoc/invoices")
								}
							}
						}
					}
